...
namespace StackExchange.Exceptional.Tests
{
    public static class TestConfig
    {
        ...
        public class Config
        {
            ...
            public string SQLServerConnectionString { get; set; } = Environment.GetEnvironmentVariable(nameof(SQLServerConnectionString)) ?? "Server=.;Database=tempdb;Trusted_Connection=True;Encrypt=False";
