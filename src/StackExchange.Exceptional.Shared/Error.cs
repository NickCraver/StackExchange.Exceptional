...
namespace StackExchange.Exceptional
{
    ...
    public partial class Error
    {
            ...
            Dictionary<string, string> initialCustomData = null)
        {
            ...
            if (Settings.Current.AppendFullStackTraces)
            {
        ...
        /// <summary>
        /// Populates the CustomData collection via <see cref="Settings.GetCustomData"/>, if set.
        /// </summary>
        private void AddCustomData()
        {
            if (Settings.Current.GetCustomData != null)
            {
                InitCustomData();
                try
                {
                    Settings.Current.GetCustomData(Exception, CustomData);
                }
                catch (Exception cde)
                {
